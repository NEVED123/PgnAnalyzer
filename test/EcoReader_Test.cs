...
public class Eco_Test
{
    ...
    {
        StringAssert.AreEqualIgnoringCase(Game.Parse("1. e4 e5").moves.ToString(), eco!.getMovesFromEco("C20")!.ToString());
    }
